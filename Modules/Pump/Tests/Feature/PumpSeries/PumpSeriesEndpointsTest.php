...
class PumpSeriesEndpointsTest extends TestCase
{
    ...
    public function test_pump_series_index_endpoint()
    {
        ...
        $this->actingAs($user)
            ...
            ->assertInertia(fn(AssertableInertia $page) => $page
                ->component('Pump::PumpSeries/Index', false)
    ...
    public function test_pump_series_create_endpoint()
    {
        $this->actingAs(User::fakeWithRole('SuperAdmin'))
            ...
            ->assertStatus(200)
            ->assertInertia(fn(AssertableInertia $page) => $page
                ->component('Pump::PumpSeries/Create', false)
    ...
    public function test_edit_pump_series_endpoint()
    {
        ...
        $this->actingAs(User::fakeWithRole('SuperAdmin'))
            ...
            ->assertStatus(200)
            ->assertInertia(fn(AssertableInertia $page) => $page
                ->component('Pump::PumpSeries/Edit', false)
                ->has('pump_series_props', fn(AssertableInertia $page) => $page
                    ->has('data', fn(AssertableInertia $page) => $page
                        ->has('brands')
                        ->has('categories')
    ...
    /**
     * @throws Exception
     * @see PumpSeriesStoreEndpoint
     * @see PumpSeriesStoreRequest
     * @author Max Trunnikov
     */
    ...
    /**
     * @return void
     * @see PumpSeriesImportMediaEndpoint
     * @author Max Trunnikov
     */
    ...
    public function test_pump_series_import()
    {
        ...
        $file = new UploadedFile(storage_path('app/testing/series/Series.xlsx'), 'Series.xlsx');
        $this->startSession()
            ->actingAs(User::fakeWithRole('SuperAdmin'))
            ->from(route('pump_series.index'))
            ->post(route('pump_series.import'), [

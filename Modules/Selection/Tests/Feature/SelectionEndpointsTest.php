...
class SelectionEndpointsTest extends TestCase
{
     ...
     */
    public function testSelectionsDashboard()
    {
     ...
     * @author Max Trunnikov
     */
    public function testSelectionsCreateEndpointWithoutSaving()
    {
     ...
     * @author Max Trunnikov
     */
    public function testSelectionsCreateEndpoint()
    {
     ...
     *
     * @see EpShowSelection
     * @see WSAutoSelectionAsResource
     *
     * @author Max Trunnikov
     */
    public function testShowSinglePumpSelection()
    {
     ...
     *
     * @see EpShowSelection
     * @see WSHandleSelectionAsResource
     *
     * @author Max Trunnikov
     */
    public function testShowDoublePumpSelection()
    {
     ...
     * @author Max Trunnikov
     */
    public function testSelectionRestore()
    {
        $user = User::fakeWithRole();
        $project = Project::fakeForUser($user);
     ...
     * @author Max Trunnikov
     */
    public function testSelectionDestroy()
    {
        $user = User::fakeWithRole();
        $project = Project::fakeForUser($user);
        $selection = Selection::fakeForProject($project);
     ...
     */
    public function testSinglePumpSelectionStore()
    {
     ...
     */
    public function testDoublePumpSelectionStore()
    {
     ...
     */
    public function testSelectionCurvesForSinglePump()
    {
     ...
     * @see EpPumpStationCurves
     */
    public function testSelectionCurvesForDoublePump()
    {
     ...
     * @author Max Trunnikov
     */
    public function testUpdateSinglePumpElection()
    {
        $this->app->bind(RqStoreSelection::class, RqStoreSinglePumpSelection::class);
        $user = User::fakeWithRole();
        $project = Project::fakeForUser($user);
     ...
     * @author Max Trunnikov
     */
    public function testUpdateDoublePumpElection()
    {
        $this->app->bind(RqStoreSelection::class, RqStoreDoublePumpSelection::class);
        $user = User::fakeWithRole();
        $project = Project::fakeForUser($user);
     ...
     * @author Max Trunnikov
     */
    public function testSelectSinglePumps(): void
    {
     ...
     * @see EpMakeSelection
     */
    public function testSelectDoublePumps(): void
    {
     ...
     * @author Max Trunnikov
     */
    public function testSelectSinglePumpsWithPrices(): void
    {
        $this->app->bind(RqMakeSelection::class, RqMakeSinglePumpSelection::class);
        $brand1 = PumpBrand::factory()->create();
        $brand2 = PumpBrand::factory()->create();
     ...
     * @author Max Trunnikov
     */
    public function testExportSelection()
    {
        $user = User::fakeWithRole();
        $project = Project::fakeForUser($user);
        $selection = Selection::fakeForProject($project);
     ...
     */
    public function testExportAtOnceSinglePumpSelection()
    {
     ...
     * @author Max Trunnikov
     */
    public function testExportAtOnceDoublePumpSelection()
    {

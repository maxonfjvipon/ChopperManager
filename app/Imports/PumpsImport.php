...
class PumpsImport implements ToModel, WithValidation, WithStartRow, WithUpserts, WithBatchInserts
{
    ...
    public function model(array $row): Pump
    {
        return new Pump([
            ...
            'power' => $row[9],
            'amperage' => $row[10],
            'connection_type_id' => ConnectionType::whereName($row[11])->first()->id,
            ...
            'category_id' => PumpCategory::whereName($row[18])->first()->id,
            'regulation_id' => PumpRegulation::whereName($row[19])->first()->id,
    ...
    public function customValidationMessages(): array
    {
        return [
            ...
            '18.required' => 'Отсутствуют категории',
            ...
            '11.exists' => 'Тип соединения не найден в БД',
            '12.exists' => 'ДУ входа не найден в БД',
            '13.exists' => 'ДУ выхода не найден в БД',
            '18.exists' => 'Категория не найдена в БД',
            '19.exists' => 'Встроенное регулирование не найдено в БД',

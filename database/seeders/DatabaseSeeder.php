...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /** * Pump Series */
        PumpSeries::create(['name' => 'MHI', 'brand_id' => 1, 'regulation_adjustment_id' => 2]);
        PumpSeries::create(['name' => 'BL', 'brand_id' => 1, 'regulation_adjustment_id' => 2]);
        PumpSeries::create(['name' => 'TOP-S', 'brand_id' => 1, 'regulation_adjustment_id' => 2]);
        PumpSeries::create(['name' => 'TOP-Z', 'brand_id' => 1, 'regulation_adjustment_id' => 2]);

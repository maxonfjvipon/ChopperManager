...
// FILTER BRANDS HANDLER
    ...
    }, [typesValue, powerAdjustmentValue, debouncedTemperature, brandsSeriesList])
        ...
        <>
            <IndexContainer
                title={selection
                    ...
                    : Lang.get('pages.selections.double_pump.title_new')}
                extra={selection
                    ...
                    <Col xxl={hideIcons ? 2 : 3} xl={hideIcons ? 3 : 4}>
                        <Row>
                            <Col xs={24}>
                                ...
                                >
                                    <span
                                        style={{marginLeft: hideIcons ? 0 : 5}}>{Lang.get('pages.selections.double_pump.grouping')}</span>
                                </Checkbox>
                            </Col>
                            {/*<Col xs={24}>*/}
                            ...
                            <Col xs={24}>
                                <Checkbox checked={hideIcons} onChange={e => {
                                    ...
                                    <span style={{marginLeft: hideIcons ? 0 : 5}}>
                                        {Lang.get('pages.selections.double_pump.hide_icons')}
                                    </span>
                                </Checkbox>
                            </Col>
                        </Row>
                            ...
                            <Row gutter={10}>
                                <Col xs={5}>
                                    ...
                                    <RequiredFormItem
                                        ...
                                        label={Lang.get('pages.selections.double_pump.brands')}
                                    >
                                        <MultipleSelection
                                            placeholder={Lang.get('pages.selections.double_pump.brands')}
                                            style={fullWidth}
                                            options={brands}
                                            onChange={values => {
                                ...
                                <Col xs={3}>
                                    ...
                                    <RequiredFormItem
                                        className={reducedAntFormItemClassName}
                                        label={Lang.get('pages.selections.double_pump.fluid_temp')}
                                    ...
                                    >
                                        <InputNumber
                                            ...
                                            placeholder={Lang.get('pages.selections.double_pump.fluid_temp')}
                                        />
                                    </RequiredFormItem>
                                </Col>
                                <Col xs={13}>
                                    ...
                                    <Form.Item
                                        className={reducedAntFormItemClassName}
                                        name="pump_type_ids"
                                        label={Lang.get('pages.selections.double_pump.types.label')}
                                        initialValue={selection?.data.pump_types}
                                        tooltip={Lang.get('pages.selections.double_pump.types.tooltip')}
                                    >
                                        <MultipleSelection
                                            placeholder={Lang.get('pages.selections.double_pump.types.label')}
                                            disabled={fieldsDisabled}
                                            style={fullWidth}
                                            options={types}
                                            onChange={values => {
                                ...
                                <Col xs={3}>
                                    ...
                                    <Form.Item
                                        className={reducedAntFormItemClassName}
                                        label={Lang.get('pages.selections.double_pump.power_adjustments')}
                                        name="power_adjustment_ids"
                                        initialValue={powerAdjustmentValue}
                                        style={marginBottomTen}
                                    >
                                        <MultipleSelection
                                            placeholder={Lang.get('pages.selections.double_pump.power_adjustments')}
                                            disabled={fieldsDisabled}
                                ...
                                <Col span={2}>
                                    {/* VOLUME FLOW */}
                                    <RequiredFormItem
                                        label={Lang.get('pages.selections.double_pump.consumption')}
                                        name="flow"
                                        initialValue={selection?.data.flow}
                                        className={reducedAntFormItemClassName}
                                    >
                                        <InputNumber
                                            placeholder={Lang.get('pages.selections.double_pump.consumption')}
                                            style={fullWidth}
                                            min={0}
                                            max={10000}
                                            precision={1}
                                ...
                                <Col span={2}>
                                    {/* DELIVERY HEAD */}
                                    <RequiredFormItem
                                        label={Lang.get('pages.selections.double_pump.pressure')}
                                        name="head"
                                        initialValue={selection?.data.head}
                                        className={reducedAntFormItemClassName}
                                    >
                                        <InputNumber
                                            placeholder={Lang.get('pages.selections.double_pump.pressure')}
                                            style={fullWidth}
                                            min={0}
                                            max={10000}
                                            precision={1}
                                ...
                                <Col span={2}>
                                    {/* DEVIATION */}
                                    <Form.Item
                                        label={Lang.get('pages.selections.double_pump.deviation')}
                                        name="deviation"
                                        initialValue={selection?.data.deviation}
                                        className={reducedAntFormItemClassName}
                                        tooltip={Lang.get('pages.selections.double_pump.deviation_tooltip')}
                                    >
                                        <InputNumber
                                            placeholder={Lang.get('pages.selections.double_pump.deviation')}
                                            style={fullWidth}
                                            min={-50}
                                            max={50}
                                            precision={1}
                                ...
                                <Col span={5}>
                                    ...
                                    <Form.Item
                                        ...
                                        initialValue={selection?.data.double_pump_work_scheme_id || workSchemes[0].id}
                                        className={reducedAntFormItemClassName}
                                    >
                                        <Radio.Group>
                                            {workSchemes.map(scheme => (
                                ...
                                <Col span={3}>
                                    ...
                                    <Form.Item
                                        required
                                        name="range_id"
                                        label={Lang.get('pages.selections.double_pump.range.label')}
                                ...
                                <Col span={4}>
                                    ...
                                    <Form.Item
                                        required
                                        name="custom_range"
                                        label={Lang.get('pages.selections.double_pump.range.custom.label')}
                                ...
                                <Col span={6}>
                                    <Row gutter={[10, 0]}>
                                        <Col span={24}>
                                            ...
                                            }}>{Lang.get('pages.selections.double_pump.additional_filters.checkbox')}</Checkbox>
                                        </Col>
                                        <Col span={12}>
                                            <Form.Item className={reducedAntFormItemClassName}>
                                                ...
                                                >
                                                    {Lang.get('pages.selections.double_pump.additional_filters.button')}
                                                </SecondaryButton>
                                            </Form.Item>
                                        </Col>
                                        <Col span={12}>
                                            <Form.Item className={reducedAntFormItemClassName}>
                                                <PrimaryButton
                                                    ...
                                                    loading={loading}
                                                >
                                                    {Lang.get('pages.selections.double_pump.select')}
                                                </PrimaryButton>
                                            </Form.Item>
                                        </Col>
                                    </Row>
                        ...
                        <Row gutter={[10, 10]} style={{display: "flex", alignItems: 'stretch', marginTop: 16}}>
                            ...
                            <Col xs={15}>
                                <RoundedCard
                                    ...
                                    type="inner"
                                    title={Lang.get('pages.selections.double_pump.table.title')}
                                >
                                    <SelectedPumpsTable
                            ...
                            <Col xs={9}>
                                <RoundedCard
                                    ...
                                    extra={stationToShow && <Space>
                                        ...
                                        }}>{Lang.get('pages.selections.double_pump.graphic.export')}</a>}
                                        <a onClick={e => {
                                            e.preventDefault()
                                            setPumpInfoDrawerVisible(true)
                                        }}>
                                            {Lang.get('pages.selections.double_pump.graphic.info')}>>
                                        </a>
                                    </Space>}
                                >
                                    <div id="for-graphic"/>
            ...
            <BoxFlexEnd style={margin.top(16)}>
                <Space size={8}>
                    <SecondaryButton onClick={() => {
                        ...
                        {Lang.get('pages.selections.double_pump.exit')}
                    </SecondaryButton>
                    {project_id !== "-1" && <>
                        <PrimaryButton
                            ...
                            loading={addLoading}
                        >
                            {Lang.get('pages.selections.double_pump.add')}
                        </PrimaryButton>
                        {selection && <PrimaryButton
                            ...
                            loading={addLoading}
                        >
                            {Lang.get('pages.selections.double_pump.update')}
                        </PrimaryButton>}
                    </>}
                </Space>
            </BoxFlexEnd>

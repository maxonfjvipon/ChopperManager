...
export default function SinglePump() {
    ...
    const [brandsValue, setBrandsValue] = useState(
        selection?.data.pump_brands.filter(brandId => brandsWithSeries.findIndex(bws => bws.id === brandId) !== -1)
        || defaults.brands
    )
        ...
        <>
            <IndexContainer
                title={selection
                    ...
                    : Lang.get('pages.selections.single_pump.title_new')}
                extra={selection
                    ...
                    <Col xxl={hideIcons ? 2 : 3} xl={hideIcons ? 3 : 4}>
                        <Row>
                            <Col xs={24}>
                                ...
                                >
                                    <span
                                        style={{marginLeft: hideIcons ? 0 : 5}}>{Lang.get('pages.selections.single_pump.grouping')}</span>
                                </Checkbox>
                            </Col>
                            {/*<Col xs={24}>*/}
